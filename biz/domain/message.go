...
type Message struct {
	...
	Type       int    `json:"type,omitempty" gorm:"type,type:;not null;"`               //发送类型  1 私聊  2 群聊  3 心跳
	Media      int    `json:"media,omitempty" gorm:"media,type:;not null;"`             //消息类型  1 文字 2 表情包 3 语音 4 图片 /表情包
